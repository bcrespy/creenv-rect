...
class SaluPicker {
  ...
  updateSV (saturation, value) {
    // this is a hack, too tired to figure out about a better conception, cause
    // this is a conception issue 
    let width = this.dom.clientWidth ? this.dom.clientWidth : 200;
    
    let pos = new Vector2(saturation, 1-value).multiplyScalar(width);
